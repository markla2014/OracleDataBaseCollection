...
public class SystemInfo {
  ...
  public String getCpuVendor() {
		Sigar sigar = new Sigar();
			...
			CpuInfo info = infos[0];
		  System.out.println("Vendor=" + info.getVendor());// CPU的制造商
	...
	public String getCpuModel() {
		Sigar sigar = new Sigar();
			...
			CpuInfo info = infos[0];
		  System.out.println("Model=" + info.getModel());// CPU的制造商
...
public String[] getCpuPerc() {
		...
		try {
			cpu = sigar.getCpuPerc();
			 ...
			 cpuperf[1]= CpuPerc.format(cpu.getSys());// 系统使用率
		   cpuperf[2]= CpuPerc.format(cpu.getWait());// 当前等待率
		   cpuperf[3]= CpuPerc.format(cpu.getNice());//
		   cpuperf[4]= CpuPerc.format(cpu.getIdle());// 当前空闲率
		   cpuperf[5]= CpuPerc.format(cpu.getCombined());// 总的使用率
